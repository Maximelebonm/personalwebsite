        ...
        return (
            <div class="z-30">
                <div class="flex flex-col justify-center w-11/12 m-auto pb-20">
                    <div>
                        <div class="TitleTech text-white text-center mt-2 text-2xl font-bold"><h2>Langages Informatiques</h2></div>
                    ...
                    <div>
                        <div class="TitleTech2 text-white text-center mt-2 text-2xl font-bold mt-4"><h2>FrameWorks et Bibliothèques</h2></div>
                        <Undertitle className="barexperience2"/>
                        <div class="grid lg:grid-cols-3 sm:grid-cols-2 justify-items-center">
                    ...
                    <div>
                        <div class="TitleTech3 text-white text-center mt-2 text-2xl font-bold"><h2>Technologies Annexes</h2></div>
                        <Undertitle className="barexperience3"/>
                        <div class="grid lg:grid-cols-3 sm:grid-cols-2 justify-items-center">
