...
const ExperienceScreen = () => {
    ...
    return (
        ...
        <div className="flex flex-col sm:w-2/3 lg:w-1/2 justify-center pb-20 lg:pb-16 mx-2 sm:mx-auto">
            <div className="text-white text-2xl m-auto w-96 font-bold text-center"><h2>Expérience professionnel dans le developpement</h2></div>
            <Undertitle />
            <div class="flex flex-col justify-center mt-4">
                ...
                <Experience className='ExperienceSlide' Date="Juin-Aout 2022" Title="Stage Tales and Keys (3mois)" desc="Conception d'application (MCD, UserCase, Maquettage, diagramme de séquence),
                développement sur flutter, utilisation de FlutterFlow"/>
            </div>
            <div className="text-white text-2xl m-auto w-96 font-bold text-center"><h2>Expérience professionnel avant ma reconversion</h2></div>
            <Undertitle />
            <div className="flex flex-col justify-center mt-4">
                ...
                />
                <Experience className='ExperienceSlide' Date="Juin 2017" Title="Stage Service Communication SEM (6 mois)" desc="Responsable graphisme et communication au Syndicat Mixte de l'Escaut pour soutenir les animations et préventions sur l'environnement." />
